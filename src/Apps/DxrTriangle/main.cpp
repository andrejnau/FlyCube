...
int main(int argc, char *argv[])
{
    ...
    std::shared_ptr<Resource> bottom_compact = upload_command_list->CreateBottomLevelAS({ raytracing_geometry_desc });
    upload_command_list->CopyAccelerationStructure(bottom, bottom_compact, CopyAccelerationStructureMode::kCompact);
