...
int main(int argc, char* argv[])
{
    ...
    std::shared_ptr<Resource> depth_stencil_pass_cbv_buffer = device->CreateBuffer(
        BindFlag::kConstantBuffer, sizeof(depth_stencil_pass_cbv_data.front()) * depth_stencil_pass_cbv_data.size());
    ...
    std::shared_ptr<Resource> vertex_cbv_buffer =
        device->CreateBuffer(BindFlag::kConstantBuffer, sizeof(vertex_cbv_data));
    ...
    std::shared_ptr<Resource> pixel_cbv_buffer =
        device->CreateBuffer(BindFlag::kConstantBuffer, sizeof(pixel_cbv_data));
