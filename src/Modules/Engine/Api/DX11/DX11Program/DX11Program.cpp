...
DX11Program::DX11Program(ComPtr<ID3D11Device>& device, const std::string & vertex, const std::string & pixel)
{
...
IShaderBuffer& DX11Program::GetVSCBuffer(const std::string & name)
{
...
IShaderBuffer& DX11Program::GetPSCBuffer(const std::string & name)
{
...
ComPtr<ID3DBlob> DX11Program::CompileShader(ComPtr<ID3D11Device>& device, const std::string & shader_path, const std::string & entrypoint, const std::string & target)
{
...
void DX11Program::ParseVariable(ComPtr<ID3D11Device>& device, ShaderType shader_type, ComPtr<ID3DBlob>& shader_buffer, std::map<std::string, DX11ShaderBuffer>& buffers)
{
