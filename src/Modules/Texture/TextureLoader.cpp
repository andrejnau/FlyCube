...
std::shared_ptr<Resource> CreateSRVFromFile(Device& device, CommandListBox& command_list, const std::string& path)
{
...
std::shared_ptr<Resource> CreateSRVFromFileDDS(Device& device, CommandListBox& command_list, const std::string& path)
{
